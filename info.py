...
MSG_ALRT = environ.get('MSG_ALRT', 'Share & Support Us @RDXMOVIEZONE ♥️') # Alert message for users
DELETE_TIME = int(environ.get("DELETE_TIME", "2000"))  #  deletion time in seconds (default: 5 minutes). Adjust as per your needs.
